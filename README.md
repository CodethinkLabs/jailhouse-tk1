...
Requirements: Vagrant 1.8.5, Virtualbox 5.1, a recent version of UBoot on the Jetson TK1 (to enable CPU HYP mode). An ext4 SDcard of at least 4GB in size

Usage: sudo ./deploy_sdcard.sh /path/to/sdcard
